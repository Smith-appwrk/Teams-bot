...
urlFragment: officedev-microsoft-teams-samples-IG bot-nodejs
---
...
**Receive Channel messages with RSC permissions:** [Manifest](/samples/IG bot/csharp/demo-manifest/Bot-RSC.zip)
...
- In the folder where repository is cloned navigate to `samples/IG bot/nodejs`
...
**Note**: If you are facing any issue in your app, please uncomment [this](https://github.com/OfficeDev/Microsoft-Teams-Samples/blob/main/samples/IG bot/nodejs/server/api/botController.js#L24) line and put your debugger for local debug.
...
<img src="https://pnptelemetry.azurewebsites.net/microsoft-teams-samples/samples/IG bot-nodejs" />